...
public class RayHandler implements Disposable {
   ...
   public void setCombinedMatrix(OrthographicCamera camera) {
      this.setCombinedMatrix(camera.combined, camera.position.x, camera.position.y, camera.viewportWidth * camera.zoom,
            camera.viewportHeight * camera.zoom);
   }
    ...
    * 
    * @return true if camera screen intersects or contains provided light, represented by circle/box
    *         area
    */
    ...
    *
    * <p>
    * You should need to use this method only if you want to render lights on a frame buffer object.
    * Use {@link #render()} otherwise.
    *
    * <p>

...
package de.bitbrain.braingdx.postprocessing.utils;
...
public final class PingPongBuffer {
    ...
    /**
     * Starts and/or continue ping-ponging, begin capturing on the next available buffer, returns
     * the result of the previous {@link #capture()} call.
     * 

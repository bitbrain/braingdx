...
public class PostProcessor implements Disposable {
   ...
   /**
    * Stops capturing the scene and apply the effect chain, if there is one. If the specified output
    * framebuffer is NULL, then the rendering will be performed to screen.
    */

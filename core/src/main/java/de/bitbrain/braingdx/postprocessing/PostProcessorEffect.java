...
public abstract class PostProcessorEffect implements Disposable {
     ...
     * needed, usually when the OpenGL context is lost. Eg., framebuffer textures should be updated
     * and shader parameters should be reuploaded/rebound.
     */
    public abstract void rebind();

    /**
     * Concrete objects shall implements its own rendering, given the source and destination
     * buffers.
     */

 ...
 * interest is that it handles the tween/timeline life-cycles for you, as well
 * as the pooling constraints (if object pooling is enabled).
 * <p/>
 *
...
public class TweenManager {
     ...
     * particular tween or timeline. This mode is activated by default. If it is
     * not enabled, add a tween or timeline to any manager won't start it
     ...
     * timeline. Note that a timeline only counts for 1 object, since it manages
     * its children itself.
     * <p/>

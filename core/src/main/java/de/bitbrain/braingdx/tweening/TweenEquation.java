...
/**
 * Base class for every easing equation. You can create your own equations and
 * directly use them in the Tween engine by inheriting from this class.
 *
 * @see Tween
...
public abstract class TweenEquation {
     ...
     * is returned in the toString() method, don't forget to override it). This
     * method is usually used to save/load a tween to/from a text file.
     */

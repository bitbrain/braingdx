...
public interface TweenPath {
     ...
     *            of these bounds if the easing equation involves some kind of
     *            rebounds.
     * @param points
     *            The waypoints of the tween, from start to target values.
     * @param pointsCnt
     *            The number of valid points in the array.

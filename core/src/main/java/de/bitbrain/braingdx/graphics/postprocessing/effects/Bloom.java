...
public final class Bloom extends PostProcessorEffect {
   ...
   public static class Settings {
      ...
      public Settings(String name, Blur.BlurType blurType, int blurPasses, float blurAmount, float bloomThreshold,
      ...
      public Settings(String name, int blurPasses, float bloomThreshold, float baseIntensity, float baseSaturation,
         ...
         this(name, Blur.BlurType.Gaussian5x5b, blurPasses, 0, bloomThreshold, baseIntensity, baseSaturation, bloomIntensity,
               bloomSaturation);
      }

...
import de.bitbrain.braingdx.graphics.postprocessing.filters.NfaaFilter;

/**
 * Implements the normal filter anti-aliasing. Very fast and useful for combining with other

...
import de.bitbrain.braingdx.graphics.postprocessing.filters.FxaaFilter;

/**
 * Implements the fast approximate anti-aliasing. Very fast and useful for combining with other

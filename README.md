...
```gradle
compile 'de.bitbrain.braingdx:braingdx-core:0.2.4'
compile 'de.bitbrain.braingdx:braingdx-core:0.2.4:sources'
compile 'de.bitbrain.braingdx:braingdx-core:0.2.4:javadoc'
```
